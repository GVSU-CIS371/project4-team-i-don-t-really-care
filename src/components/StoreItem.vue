      ...
      <v-col>
        ...
        <v-row >
          <v-col class="d-flex flex-column align-center justify-center" style="gap: 12px;">
            ...
            <v-chip variant="outlined" color="green" text-color="white" label>Price: ${{ product.data.price }}</v-chip>
            <v-chip variant="outlined" color="blue" text-color="white" label>Stock: {{ product.data.stock }}</v-chip>
